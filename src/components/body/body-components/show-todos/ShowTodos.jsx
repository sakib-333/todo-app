...
function ShowTodos() {
  ...
  return (
    <div className="mx-auto">
      <div className="text-center grid grid-cols-5 md:grid-cols-6 gap-3 border-b-2 pb-3">
        <h1 className="font-bold text-[12px] md:text-base hidden md:block">
          #
        </h1>
        <h1 className="font-bold text-[12px] md:text-base">Title</h1>
        <h1 className="font-bold text-[12px] md:text-base">Completed</h1>
        <h1 className="font-bold text-[12px] md:text-base">View</h1>
        <h1 className="font-bold text-[12px] md:text-base">Edit</h1>
        <h1 className="font-bold text-[12px] md:text-base">Delete</h1>
      </div>
      {todos.map((todo) => {
        return (
          <div
            key={todo.id}
            className="text-center grid grid-cols-5 md:grid-cols-6 gap-3 items-center py-3 border-b"
          >
            <h1 className="hidden md:block">{todoSequence++}</h1>
            <h1>{todo.title}</h1>
            <label
